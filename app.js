    ...
    .addEventListener(
      ...
      async event => {
        ...
        const updates = {
          ...
          invoice_number:
            document
              .getElementById("editInvoiceNumber")
              .value.trim(),
          ...
          subtotal:
            Number(
              document
                .getElementById("editInvoiceSubtotal")
                .value
            ) || 0,
          ...
          total:
            Number(
              document
                .getElementById("editInvoiceTotal")
                .value
            ) || 0,

          issue_date:
            document
              .getElementById("editInvoiceIssueDate")
              .value || null,

          due_date:
            document
              .getElementById("editInvoiceDueDate")
              .value || null,
          ...
          notes:
            document
              .getElementById("editInvoiceNotes")
              .value.trim()
        };
