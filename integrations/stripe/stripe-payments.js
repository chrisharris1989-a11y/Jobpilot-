...
window.createInvoiceCheckout = async function (supabase, invoiceId) {
  ...
  } catch(error) { console.error("JobPilot Stripe checkout error:",error); alert("Could not create payment:\n\n"+(error.message||String(error))); if(button){button.disabled=false;button.textContent="💳 Pay Online";} }
};
