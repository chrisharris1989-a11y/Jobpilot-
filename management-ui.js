...
function renderManagementPage() {
  ...
  content.innerHTML = `
    ...
    <div class="content-grid">
      ...
      <button class="panel jobpilot-management-card" type="button" data-management-section="quote-requests" style="text-align:left;cursor:pointer;border:1px solid var(--border,#e5e7eb)"><div class="panel-header"><div><h2>💷 Requests</h2><p>Review requests submitted by your team and customers.</p></div><span aria-hidden="true">→</span></div><p class="muted" style="margin:16px 0 0">Review requests and create draft quotes for customers.</p></button>
