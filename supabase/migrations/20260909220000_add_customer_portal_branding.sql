...
as $$
  select c.name, us.business_logo_url
...
revoke all on function public.get_customer_portal_branding() from public;
grant execute on function public.get_customer_portal_branding() to authenticated;
