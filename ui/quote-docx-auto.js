...
function installPreviewStyles() {
  ...
  style.textContent = `
    .jp-quote-preview-backdrop{position:fixed;inset:0;background:rgba(15,23,42,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:20px;overflow:auto}
    .jp-quote-preview{width:min(900px,100%);max-height:calc(100vh - 40px);overflow:auto;background:#fff;border-radius:14px;box-shadow:0 20px 60px rgba(0,0,0,.25);color:#111827}
    .jp-quote-preview-head{display:flex;justify-content:space-between;align-items:flex-start;gap:16px;padding:22px 24px;border-bottom:1px solid #e5e7eb;position:sticky;top:0;background:#fff;z-index:2}
    ...
    .jp-quote-preview-body{padding:28px}.jp-quote-preview-company{display:flex;justify-content:space-between;gap:24px;margin-bottom:30px}.jp-quote-preview-company h1{margin:0 0 5px;font-size:25px}.jp-quote-preview-logo{max-width:180px;max-height:80px;object-fit:contain}
    .jp-quote-preview-grid{display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:26px}.jp-quote-preview-card{padding:16px;background:#f8fafc;border-radius:10px}.jp-quote-preview-card h4{margin:0 0 8px;font-size:12px;text-transform:uppercase;color:#64748b;letter-spacing:.05em}.jp-quote-preview-card p{margin:3px 0;white-space:pre-line}
    .jp-quote-preview-table{width:100%;border-collapse:collapse;margin:20px 0}.jp-quote-preview-table th,.jp-quote-preview-table td{padding:10px 8px;border-bottom:1px solid #e5e7eb;text-align:left}.jp-quote-preview-table th{font-size:12px;text-transform:uppercase;color:#64748b}.jp-quote-preview-num{text-align:right!important}
    .jp-quote-preview-totals{margin-left:auto;width:min(360px,100%)}.jp-quote-preview-total{display:flex;justify-content:space-between;padding:7px 0}.jp-quote-preview-total.grand{font-size:20px;font-weight:700;border-top:2px solid #111827;margin-top:6px;padding-top:12px}.jp-quote-preview-section{margin-top:26px}.jp-quote-preview-section h3{margin-bottom:8px}.jp-quote-preview-actions{display:flex;gap:10px;justify-content:flex-end;padding:18px 24px;border-top:1px solid #e5e7eb;position:sticky;bottom:0;background:#fff}.jp-quote-preview-actions button{cursor:pointer}.jp-quote-preview-loading{padding:50px;text-align:center;color:#64748b}
    @media(max-width:650px){.jp-quote-preview-body{padding:18px}.jp-quote-preview-grid{grid-template-columns:1fr}.jp-quote-preview-company{flex-direction:column}.jp-quote-preview-actions{flex-wrap:wrap}.jp-quote-preview-actions button{flex:1}.jp-quote-preview-table{font-size:13px}}
  `;
