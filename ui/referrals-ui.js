...
function renderSummary(container, promoters, rows) {
...
export async function renderReferralsPage() {
  ...
  try {
    ...
    renderSummary(document.getElementById("referral-summary"), promoters, rows); renderPromoters(document.getElementById("referral-promoters"), promoters); renderReferralRows(document.getElementById("referral-customers"), rows);
