...
function renderSummary(container, rows) {
  ...
  if (!document.getElementById("jobpilot-referral-stats-style")) {
    ...
    style.textContent = ".referral-stats{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px}.referral-stats .stat-card{min-width:0}@media(max-width:900px){.referral-stats{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:560px){.referral-stats{grid-template-columns:1fr}}";
