import { loadUserPermissions, can, isRestrictedUser } from "./user-permissions.js";
const NAV_PERMISSIONS={customers:"customers",jobs:"jobs",quotes:"quotes",invoices:"invoices",connections:"connections",settings:"settings"};
